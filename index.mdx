---
title: "Welcome"
description: "Welcome to the **Origin Creations** documentation. Here, you'll find everything you need to know about our team, our products, our terms of service and much more.

<Warning> You cannot use `api` for the name of a folder unless you nest it inside another folder. Mintlify uses Next.js which reserves the top-level `api` folder for internal server calls. A folder name such as `api-reference` would be accepted. </Warning>
